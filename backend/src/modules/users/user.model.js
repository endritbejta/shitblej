...
// Sign a JWT carrying this user's id. Keeping token generation on the model
// gives auth logic a single home instead of scattering it across services.
...
// Compare a candidate password against the stored hash. The document must be
// loaded with `.select("+password")` for this to work.
